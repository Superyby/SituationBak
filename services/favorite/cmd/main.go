...
var (
	...
	grpcPort   = flag.Int("port", 50054, "gRPC服务端口")
)
...
func main() {
	...
	logger.Info("启动收藏服务",
		logger.String("service", "favorite-svc"),
	...
	// TODO: 注册收藏服务
	// favoriteServer := server.NewFavoriteServer(...)
	// server.RegisterFavoriteServiceServer(grpcServer, favoriteServer)
